...
function farcasterManifest(origin) {
  ...
  return {
    ...
    miniapp: {
      ...
      imageUrl: `${origin}/assets/rektaurant-table-scene-v1.jpg`,
      ...
      heroImageUrl: `${origin}/assets/rektaurant-table-scene-v1.jpg`,
      ...
      ogImageUrl: `${origin}/assets/rektaurant-table-scene-v1.jpg`,
